...
class TidsseriePlotter:
    def __init__(self, filsti: str,enhet: str , periode: str = 'år', konvertering: float = 1, visningsnavn: str = "Verdi", start: str=None, slutt: str=None, graf_type: str = 'line' ):
        ...
        self.start=start
        self.slutt=slutt
        self.graf_type = graf_type.lower()
        self.data_dict = {}
        self.behandle_data()
    ...
    def vis_graf(self, mean=True, median = True, maximum = True, minimum = True, linje=True,bar=None, scatter=None, maxverdi:float=None, minverdi: float =None):
        ...
        if self.graf_type ==  'scatter':
 
            plt.scatter(self.agg_df()["Tidspunkt"], self.agg_df()["Verdi"], label=f"{self.visningsnavn} ({self.periode})")
...
'''
class Plotter:
    def __init__(self, filsti: str,enhet: str , periode: str = None, konvertering: float = 1, visningsnavn: str = "Verdi", start: str=None, slutt: str=None ):
        self.filsti = filsti # Sti for å finne filen
        self.visningsnavn = visningsnavn  # Hva grafen viser (f.eks. "Temperatur" eller "Vannføring")
        self.periode = periode #dag, uke, måned eller år, for å endre antall datapunkter etter behov
        self.enhet = enhet #Enheten til grafen
    ...
    def behandle_data(self):  
       ...
       #fikser alle nan om det er noen
        ...
        # Lager dict med tidspunktene og verdiene
            ...
            raise ('Periode kan ikke inneholde symboler eller tall')
